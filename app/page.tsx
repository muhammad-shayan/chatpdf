  ...
  return (
    <>
      <section id="hero-section">
        ...
        <div>
          <div className="relative isolate">
            <div
              className="pointer-events-none absolute inset-x-0 -top-40 -z-10 overflow-hidden blur-3xl sm:-top-80 transform-gpu"
              aria-hidden="true"
            >
              <div
      ...
      <section id="features-section">
        <div className="my-32 sm:mt-56 max-w-5xl mx-auto">
          ...
          <ol className="my-8 space-y-4 px-6 lg:px-8 md:flex md:space-x-12 md:space-y-0">
            <li className="md:flex-1">
              <div className="flex flex-col border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pt-4 md:pl-0">
